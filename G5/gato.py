...
def hay_ganador(tablero):
    for simbolo in ["x", "o"]:
        ...
        diagonal_1 = tablero[0][0] == simbolo and tablero[2][2] == simbolo and tablero[4][4] == simbolo
        diagonal_2 = tablero[4][0] == simbolo and tablero[2][2] == simbolo and tablero[0][4] == simbolo
...
while turno < 9:
    if jugador_1 == " ":
        ...
        if turno_1:
            print(jugador_1 + ",Elige una posición")
        else:
            print(jugador_2 + ",Elige una posición")
        jugada = int(input())
